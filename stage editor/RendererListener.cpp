...
RendererListener::RendererListener( Ogre::RenderWindow * win, Ogre::Camera * cam,
								   bool useBufferedInputKeys, bool useBufferedInputMouse)
{
	...
	else
	{
		...
		//mInputDevice->initialise(win, true, true); // you can have GUI mouse cursor
	}
...
RendererListener::~RendererListener(void)
{
	if (mInputTypeSwitchingOn)
	{
...
void RendererListener::updateStats(void)
{
...
bool RendererListener::frameStarted(const FrameEvent& evt)
{
...
bool RendererListener::processUnbufferedKeyInput(const FrameEvent& evt)
{
...
bool RendererListener::processUnbufferedMouseInput(const FrameEvent& evt)
{
...
void RendererListener::moveCamera()
{
...
void RendererListener::showDebugOverlay(bool show)
{
    if (mDebugOverlay)
    {
        if (show)
...
bool RendererListener::frameEnded(const FrameEvent& evt)
{
    updateStats();
    return true;
}

void RendererListener::switchMouseMode() 
{
    mUseBufferedInputMouse = !mUseBufferedInputMouse;
	mInputDevice->setBufferedInput(mUseBufferedInputKeys, mUseBufferedInputMouse);
}

void RendererListener::switchKeyMode() 
{
    mUseBufferedInputKeys = !mUseBufferedInputKeys;
	mInputDevice->setBufferedInput(mUseBufferedInputKeys, mUseBufferedInputMouse);
}

void RendererListener::keyClicked(KeyEvent* e) 
{
	if (e->getKeyChar() == 'm')
	{
		switchMouseMode();
...
void RendererListener::keyPressed(KeyEvent* e) {}
void RendererListener::keyReleased(KeyEvent* e) {}